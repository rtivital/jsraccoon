...
description: "Настало время применить все ваши навыки объектно-ориентированного JavaScript и создать небольшую библиотеку."
---
...
var settings = {
  ...
  messages: {
    ...
    min: 'Поле не должно содержать больше 50 символов',
