...
var ParotGrandfather = function() {};
ParotGrandfather.prototype = {
  species: 'parot',
  paws: 2
};

// Отец попугай унаследовал всё у деда
var ParotFather = function() {};
ParotFather.prototype = Object.create(ParotGrandfather.prototype);

// Сын попугай унаследовал всё у отца
var ParotSon = function() {};
ParotSon.prototype = Object.create(ParotFather.prototype);

var grandfather = new ParotGrandfather();
var father = new ParotFather()
var son = new ParotSon();

console.log(grandfather.species, father.species, son.species);
// parot parot parot - все попугаи!
console.log(grandfather.paws, father.paws, son.paws);
// 2 2 2 - у каждого по 2 лапы

// Дед меняет количество лап
ParotGrandfather.prototype.paws++;
console.log(grandfather.paws, father.paws, son.paws);
// 3 3 3 - у каждого теперь по 3 лапы

// Отец меняет вид
ParotFather.prototype.species = 'eagle';
console.log(grandfather.species, father.species, son.species);
// parot eagle eagle - дед остался попугаем, отец и сын стали орлами

// Сын уменьшил количество лап
ParotSon.prototype.paws--;
console.log(grandfather.paws, father.paws, son.paws);
// 3 3 2 - дед и отец остались при своих трёх лапах

// Дед решил стать чайкой
ParotGrandfather.prototype.species = 'seagull';
console.log(grandfather.species, father.species, son.species);
